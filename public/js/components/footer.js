...
/**
 * Escape URL-like values for safe double-quoted attributes.
 * @param {string} value
 * @author Jiahao
 */
...
/**
 * Escape label text before injecting into nav HTML.
 * @param {string} value
 * @author Jiahao
 */
...
/**
 * Return inline SVG icon for the Map tab.
 * @returns {string}
 * @author Jiahao
 */
...
/**
 * Return inline SVG icon for the Analytics tab.
 * @returns {string}
 * @author Jiahao
 */
...
/**
 * Return inline SVG icon for the Alerts tab.
 * @returns {string}
 * @author Jiahao
 */
